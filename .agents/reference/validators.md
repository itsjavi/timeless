...
| `README.md's anchor-positioning bullet omits <components>`     | A component started calling `syncFloatingAnchor` and the README's anchored-surface list was not updated                 | Name it in the bullet, and correct the count word in the same sentence                                            |
