...
export const Default = {
  ...
  render: () => `<main class="ui-demo-page">
    <header>
      <h1>List</h1>
      <p>Lists use native <code class="ui-code">ul</code> and <code class="ui-code">ol</code> elements with optional divided or inset presentation.</p>
    </header>
