/**
 * Svelte declarations for every Timeless custom element, generated from the component
 * registry. Types only: importing this module adds no runtime code and no Svelte dependency.
 *
 * Both event spellings are emitted so the declarations type-check under Svelte 4 `on:ui-change` and Svelte 5 `onui-change`.
 */
